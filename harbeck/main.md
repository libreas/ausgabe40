...
[^1]: Dabei sind "koloniale Kontexte" explizit offengehalten und
    unterliegen weder einem Zeitschnitt noch einer regionalen
    Fokussierung (zum Beispiel auf ehemalige deutsche Kolonien). Eine
    kurze Begriffsdefinition, der ich mich anschließe, findet sich bei
    Ahrndt et al. 2018, S. 11--15, dabei insbesondere S. 14f.
